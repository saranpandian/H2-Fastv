    ...
    def inference(prompts,images,append_output=""):
        ...
        for prompt,image in tqdm(zip(prompts,images),total=len(prompts)):
            ...
            if image is not None:
                # first message
                # print(DEFAULT_IM_START_TOKEN, tokenizer.encode(DEFAULT_IMAGE_TOKEN), tokenizer.encode("The time has come"), DEFAULT_IMAGE_TOKEN, DEFAULT_IM_END_TOKEN)
